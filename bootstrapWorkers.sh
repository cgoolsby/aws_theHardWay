...
####change 'hostname' value for rest of script to worker-#
...
INTERNAL_IP0=`echo ${privateIPs[3]} | awk '{$1=$1;print}'`
INTERNAL_IP1=`echo ${privateIPs[4]} | awk '{$1=$1;print}'`
...
{
  sudo mv ${WORKERNAME}-key.pem ${WORKERNAME}.pem /var/lib/kubelet/
  sudo mv ${WORKERNAME}.kubeconfig /var/lib/kubelet/kubeconfig
